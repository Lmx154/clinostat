    ...
    <div className="container">
      <div className="grid-container">
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 place-items-center px-6 pb-20">
          {/* Pass connection status and sensor value to each MotorBox */}
      ...
      <div className="fixed bottom-4 right-4 flex items-center gap-4">
        ...
        <svg 
          ...
          strokeWidth="1.5" 
          stroke="currentColor" 
          className="w-6 h-6 cursor-pointer opacity-60 hover:opacity-100 transition-all duration-300 hover:rotate-90"
        >
